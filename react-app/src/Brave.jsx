...
export default function Brave() {
        ...
        navigate('/Bookticket', { 
            state: { 
                movie: "Captian America : Brave New World", 
                selectedDate, 
                selectedShow, 
                selectedClass,  
                totalAmount 
    ...
    return (
        <>
            ...
            <h2>Captian America : Brave New World</h2>
            <div className="image-container1">
                       <div className="image-item2">
                    <img src="./images/save2.jpg"  alt="Captian America : Brave New World" />
            </div>
            <div className="image-item2">
                    <img src="./images/save.jpg"  alt="Captian America : Brave New World" />
                    <p className="image-name">IMDB : 7.8/10</p>
                    <p className="image-name">Rotten Tomotoes : 70%</p>
            </div>
            <div className="image-item1">
            <video  controls>
  <source src="./trailer/bravet.mp4" type="video/mp4"></source></video>

            </div>
            </div>
                <div className='center'>
                    <div className='box'>
                <p>GENERES : Action/Sci-fi</p>
            <p>Distributed by: Walt Disney Studios Motion Pictures</p><p>
            Based on: Marvel Comics</p>
            <p>Director : <a href='hhttps://en.wikipedia.org/wiki/Julius_Onah'>Julius Onah</a></p>
             <p>Cast : <a href='https://en.wikipedia.org/wiki/Anthony_Mackie'>Anthony Mackie</a> ,
             <a href='https://en.wikipedia.org/wiki/Harrison_Ford'>Harrison Ford</a> ,
             <a href='https://en.wikipedia.org/wiki/Seth_Rollins'>Seth Rollins
             </a> ,
             <a href='https://en.wikipedia.org/wiki/Shira_Haas'>Israeli actress
</a>.
             </p>       
            </div>
                <p>Sam finds himself in the middle of an international incident after 
                    meeting with President Thaddeus Ross. He must soon discover the reason behind a nefarious global plot before the 
